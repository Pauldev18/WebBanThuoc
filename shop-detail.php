...
<html lang="en">
    ...
    <?php
            ...
            if(isset($_GET["productID"])){
                $getProductByID = "select * FROM thuoc JOIN danhmucthuoc ON thuoc.MaLoai = danhmucthuoc.MaLoai where thuoc.MaThuoc=". $_GET["productID"];
            }
            else{
                header("Location: /WebBanThuoc/404.php");
                exit();
            }
            $AllProduct = $conn->query($getProductByID);
        ?> 
    <body>
                        ...
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div class="border rounded">
                                    <a href="#">
                                        <img src="data:image/png;base64, <?php echo $imageProduct?>" class="img-fluid rounded" alt="Image" style="width: 100%; height: auto;" >
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <h4 class="fw-bold mb-3"><?php echo $nameProduct?></h4>
                                <p class="mb-3">Category: <?php echo $nameCate?></p>
                                
                                <h5 class="fw-bold mb-3"><?php echo number_format($price, 0, ',', ',');?>VND</h5>
        ...
        ?>
                ...
                <div class="vesitable">
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        ...
                        $getRelated = $conn->query("select * from thuoc join danhmucthuoc on thuoc.MaLoai = danhmucthuoc.MaLoai where thuoc.MaLoai=". $cateID);
                       
                        // Lặp qua dữ liệu sản phẩm
                        while ( $rowRelated = $getRelated->fetch_assoc()) { 
                            $pID = $rowRelated['MaThuoc'];
                            $nameProductRelated = $rowRelated['TenThuoc'];
                            $nameCateRelated = $rowRelated['TenLoai'];
                            $priceRelated = $rowRelated['GiaTien'];
                            $desRelated = $rowRelated['Des'];
                            $imageProductRelated = $rowRelated['Anh'];
                        ?>
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="data:image/png;base64, <?php echo $imageProductRelated; ?>" class="img-fluid w-100 rounded-top" alt="" style="width: 100%; height: 100%;">
                            </div>
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;"><?php echo $nameCateRelated; ?></div>
                            <div class="p-4 pb-0 rounded-bottom">
                            <h4><a href="/WebBanThuoc/shop-detail.php?productID=<?php echo $pID?>"><?php echo $nameProductRelated?></a></h4>
