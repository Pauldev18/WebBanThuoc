            ...
            <tr>
              <th scope="row">
                <div class="d-flex align-items-center">
                  <img src="data:image/png;base64, <?php echo $item["image"]?>" class="img-fluid me-5 rounded-circle"
              ...
              <td>
                <div class="input-group quantity mt-4" style="width: 100px;">
                  ...
                  <input type="text" class="form-control form-control-sm text-center border-0 quantityInput"
                    value="<?php echo $item["SoLuong"]?>" onchange="updateTotalPrice()">
              ...
              <td>
                <button class="btn btn-md rounded-circle bg-light border mt-4">
                  <a class="fa fa-times text-danger" onclick="deleteItem()"
                    href="?action=remove&code=<?php echo $item["code"];?>"></a>
                </button>
              </td>
            </tr>
            <?php
...
?>
  ...
  function updateTotalPrice() {
    // Lấy giá trị mới từ ô input bằng id
    var input = document.querySelector(".quantityInput");
    var newQuantity = parseInt(input.value);

    var giaTien = parseFloat(document.querySelector('.gia-tien').textContent);

    // Tính toán lại totalPrice
    var totalPrice = parseInt(newQuantity) * parseFloat(giaTien);

    // Hiển thị lại totalPrice ở đâu đó trong trang
    document.querySelector('.total-price').textContent = totalPrice;
  }

  function deleteItem() {
    alert("Xóa thành công");
    $('#toast').show(); // Hiển thị modal thông báo xóa thành công
  }
  </script>
